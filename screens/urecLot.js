...
import { ImageBackground, View, Text, TouchableOpacity, StyleSheet, TextInput, Platform, Image } from 'react-native';
...
const urecLot = ({ navigation}) => {
    ...
    const data = ["Front nine lot", "PFT lot", "Union lot"];
    return(
